...
import com.extension.ui.contextMenu.MainContextMenu;
import com.extension.ui.suiteTab.MainSuiteTab;
        ...
        try{
            ...
            if (sharedParameters.get_isUILoaded() && !anotherExist) {
                try {
                    ...
                    if (sharedParameters.features.hasTopMenu && sharedParameters.topMenuBar != null)
